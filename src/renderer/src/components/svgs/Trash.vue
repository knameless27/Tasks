<template>
  <svg xmlns="http://www.w3.org/2000/svg" @click="emit('onClick', data)" :fill="props.color" :width="props.width"
    :height="props.height" viewBox="0 0 50 50" style="cursor: pointer">
